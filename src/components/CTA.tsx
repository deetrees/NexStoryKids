    ...
    <section className="py-16 bg-gradient-to-br from-purple-500 via-pink-500 to-yellow-500 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-16">
          <button className="group relative bg-white text-purple-600 px-16 py-8 rounded-full text-3xl font-bold hover:shadow-2xl transition-all duration-300 flex items-center space-x-4 hover:scale-110 border-6 border-yellow-300 animate-pulse hover:animate-bounce overflow-hidden">
